# Verbatim copy of `colorednoise.py` from
#   https://github.com/felixpatzelt/colorednoise
# (c) 2014-2017 Felix Patzelt -- MIT License, see LICENSES/colorednoise-MIT.txt.
# Kept unmodified so updates can be diffed against upstream.
#
# Algorithm: Timmer & Koenig, "On generating power law noise",
# Astron. Astrophys. 300, 707 (1995).
